...
Revision ID: fe0c56011c76
Revises: 
Create Date: 2020-02-21 17:12:12.020268
...
def upgrade():
    ...
    op.create_index(op.f('ix_revised_message_timestamp'), 'revised_message', ['timestamp'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_revised_message_timestamp'), table_name='revised_message')
